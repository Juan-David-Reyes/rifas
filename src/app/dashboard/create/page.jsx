          ...
          <div className="p-8 sm:p-12 animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full bg-[#009ee3] hover:bg-[#0089c4] text-white px-8 py-4 rounded-2xl font-bold shadow-lg transition-all flex items-center justify-center gap-3 disabled:opacity-70"
              >
