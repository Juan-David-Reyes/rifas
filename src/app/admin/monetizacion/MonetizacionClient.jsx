    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden p-6 md:p-8">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          ...
          <label className={`relative flex cursor-pointer rounded-2xl border-2 p-6 focus:outline-none transition-all ${
            ...
            <div className="flex w-full items-center justify-between">
              <div className="flex items-center gap-4">
                <div className={`p-3 rounded-xl ${formData.fee_type === 'ticket' ? 'bg-primary-100 text-primary-600' : 'bg-gray-100 text-gray-500'}`}>
          ...
          <label className={`relative flex cursor-pointer rounded-2xl border-2 p-6 focus:outline-none transition-all ${
            ...
            <div className="flex w-full items-center justify-between">
              <div className="flex items-center gap-4">
                <div className={`p-3 rounded-xl ${formData.fee_type === 'fixed' ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-500'}`}>
        ...
        {formData.fee_type === 'fixed' && (
          <div className="mt-6 p-6 bg-gray-50 border border-gray-200 rounded-2xl animate-in fade-in slide-in-from-top-4 duration-300">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full rounded-xl border-gray-300 pl-8 pr-12 focus:border-green-500 focus:ring-green-500 text-lg font-bold py-3 shadow-sm"
                placeholder="20000"
                min="0"
                step="1000"
              />
