      ...
      <div className="bg-white p-6 rounded-[32px] border border-gray-100 space-y-4">
        <div className="flex justify-between items-center border-b border-gray-100 pb-2 mb-4">
          ...
          <button 
            ...
            className="text-primary-600 hover:text-primary-700 bg-primary-50 hover:bg-primary-100 px-3 py-1.5 rounded-[16px] text-sm transition-colors flex items-center gap-1 cursor-pointer font-bold"
          >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                  <div>
                    ...
                    <select 
                      ...
                      className="w-full px-4 py-3 bg-white border border-gray-200 rounded-[16px] focus:ring-2 focus:ring-gray-900 outline-none transition-all font-medium text-sm cursor-pointer"
                    >
                  ...
                  <div className={!showAccountType ? 'sm:col-span-2' : ''}>
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-3 bg-white border border-gray-200 rounded-[16px] focus:ring-2 focus:ring-gray-900 outline-none transition-all font-medium text-sm placeholder:font-normal placeholder:text-gray-400"
                    />
                  </div>
                </div>
      ...
      <div className="bg-white p-6 rounded-[32px] border border-gray-100 space-y-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input type="password" name="mercadopago_token" value={formData.mercadopago_token} onChange={handleChange} placeholder="APP_USR-..." className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-[16px] focus:ring-2 focus:ring-gray-900 outline-none font-mono" />
          </div>
          <div>
            <label className="text-sm font-bold text-gray-700 mb-2 block">ePayco Public Key</label>
            <input type="password" name="epayco_token" value={formData.epayco_token} onChange={handleChange} placeholder="Public Key..." className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-[16px] focus:ring-2 focus:ring-gray-900 outline-none font-mono" />
          </div>
        </div>
      </div>
    </div>
